...
<pre>var MyConstructor = Pure.constructor.create(function () {
...
<pre>var MyOtherConstructor = Pure.constructor.create(function () {
...
<pre>var MyOtherConstructor2 = (function(base) {
    return Pure.constructor.create(function () {
      ...
      // Empty prototype members.
          ...
          <p>Create a constructor inheriting a constructor's prototype ...</p>
<pre>var MyOtherConstructor3 = (function(base) {
    return Pure.constructor.create(function () {
        // Call the base constructor.
        base.call(this);
      }, {
